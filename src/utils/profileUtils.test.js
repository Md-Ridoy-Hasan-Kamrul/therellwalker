...
import { getProfilePicture, getUserInitials, isValidProfilePic } from './profileUtils';
...
const testUserData = {
  ...
  "profilePic": "https://lh3.googleusercontent.com/a/ACg8ocJjSsjr7hy-KjcwtTaaq2IuKA9hwE7M9_OFlFqviJpqDNMddyw=s96-c",
  "isVerified": true,
...
console.log('Result:', getProfilePicture(testUserData.profilePic, `${testUserData.fname} ${testUserData.lname}`));
...
console.log('Result:', getProfilePicture(nullProfilePic, `${testUserData.fname} ${testUserData.lname}`));
...
console.log('Result:', getProfilePicture(stringNullProfilePic, `${testUserData.fname} ${testUserData.lname}`));
...
console.log('Result:', getProfilePicture(emptyProfilePic, `${testUserData.fname} ${testUserData.lname}`));
...
console.log('Initials:', getUserInitials(`${testUserData.fname} ${testUserData.lname}`));
